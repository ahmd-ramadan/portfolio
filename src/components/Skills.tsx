             ...
             <div className="bg-muted/50 rounded-lg p-4">
              ...
              <div className="flex flex-wrap gap-2">
                {["Node.js", "Express", "GraphQL", "REST APIs", "WebSockets", "Microservices", "Socket.io"].map(skill => (
                  <div key={skill} className="text-[12px] inline-flex items-center rounded-md border focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 px-3 py-1.5 text-sm font-medium transition-colors">{skill}</div>
                ))}
              </div>
            </div>
