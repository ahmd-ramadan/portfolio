...
const LinkedInIcon = ({ height, width }: ILinkedinIconProps) => {
    return <svg className="fill-blue-800" height={height} width={width} version="1.1" id="Shopicons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
