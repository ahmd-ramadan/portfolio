            ...
            >
                <div className="flex aspect-square cursor-pointer items-center justify-center rounded-full" style={{ width: "40px" }}>
                    <div className="relative group">
                        ...
                        <span className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-full mt-2 hidden group-hover:block whitespace-nowrap rounded-md bg-foreground px-2 py-1 text-xs text-background shadow">
                            Home
                        </span>
                    </div>
                </div>
                ...
                <div 
                    ...
                    style={{width: "40px"}}
                >
                    <div className="relative group" role="link" tabIndex={0}>
                        <Link 
                            target="_blank" 
